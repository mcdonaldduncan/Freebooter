...
public class CameraShake : MonoBehaviour
{
    ...
    [SerializeField] private static float shakeDuration = 0.5f; // The duration of the shake effect
    [SerializeField] private float shakeMagnitude = 0.1f; // The magnitude of the shake effect
    [SerializeField] private float dampingSpeed = 1.0f; // The speed at which the shake effect dampens over time
